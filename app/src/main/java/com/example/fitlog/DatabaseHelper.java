    ...
    public void seedData() {
        ...
        for (String templateName : templateNames) {
            ...
            for (String exerciseName : exerciseNames) {
                ...
                exerciseValues.put("name", exerciseName);
                exerciseValues.put("instruction", "Perform the " + exerciseName + " with proper form");
                exerciseValues.put("bodypart", "Full Body");
                exerciseValues.put("category", "Strength");
